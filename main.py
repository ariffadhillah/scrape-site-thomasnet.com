...
headers = {
    ...
    'cookie':'PHPSESSID=bt3j5ihfdtu8b96o2b56vc58f5; tnet_sid=fe9c5993-10d3-4ef4-b51b-43a4ca757913; _ga=GA1.2.875644548.1678179744; _gid=GA1.2.616245202.1678179744; _gcl_au=1.1.1887114947.1678179745; ln_or=eyIxMjEwODkiOiJkIn0=; _fbp=fb.1.1678179746477.2092807830; __adroll_fpc=c656b51d401c13824e03676a966a5c8f-1678179747654; hubspotutk=655ed3494757d8383a456b37cc5aa858; QuantumMetricUserID=78fa5bcf32202bb249d709719d4d2faf; privacy_disclosure=true; tinid=229579193; refresh_token_cookie=v1.MYiQb6KN6UDZGNq5WmDWwX2lZIvJVHnnJk4jYhSI6WsVHFAgP6JSZfc8aDeg3TPcwBGyynHIays68KSEFf4REgw; UUID=229579193; _usrvst=5; _tnetses=6407ff58917a8-00; tnetMode=suppliers; sitetab=supp; sitemode=supp; comphd=26096008; compcov=NA; slsb=; tnetsearch=; __hstc=193920946.655ed3494757d8383a456b37cc5aa858.1678179756850.1678210476486.1678245740062.11; __hssrc=1; QuantumMetricSessionID=77a539cab77a4f30f9ad6039ec1645be; LS=/nsearch.html?act=M&cov=NA&heading=26096008&navsec=modify&what=digital; amp_4b1323=AqQmNtFqFip3mlj_VT0RmX.MjI5NTc5MTkz..1gqvjrao8.1gqvjs4m0.0.4h.4h; _uetsid=c770ac50bcc611ed864705673e739b77; _uetvid=c7713990bcc611ed83d42d526fc0209c; __ar_v4=IL2VZMDA4VFJNJQGZKZOG5:20230306:2|KJ5TD77QTZBR7EEU7K2NHB:20230306:143|TMTAKRB6LBBSVK3AQQGICC:20230306:146|22GNI4SB75HHRGB3B3KOOG:20230306:146; __hssc=193920946.2.1678245740062; amp_4b1323_thomasnet.com=AqQmNtFqFip3mlj_VT0RmX.MjI5NTc5MTkz..1gqvjraom.1gqvjsb4h.ir.ja.165; utag_main=v_id:0186bb4ea84e0032058b6381439405081001a0790086e$_sn:7$_ss:0$_st:1678247568303$dc_visit:7$ses_id:1678245730055;exp-session$_pn:2;exp-session$dc_event:9;exp-session$dc_region:ap-east-1;exp-session'
}

# res = requests.get(url, headers=headers).text
for page in range(1,6):
    r = requests.get(f'https://www.thomasnet.com/nsearch.html?cov=NA&heading=26096008&what=digital&pg={page}')
...
for link in itemlinkdataSupplier:
    ...
    soup = BeautifulSoup(r.content, 'lxml')
    element_company_name = soup.find('h1', {'class': 'copro-supplier-name'})
    try:
    ...
    # print(phone_number)
    try:
        website = soup.find('a', class_='visit-website-link')['href'].replace('/.', '')
    except:
        website = 'None'
    try:
    ...
    try:
        No_of_Employees = textdisckription.find_all('div', {'class': 'bizdetail'})[4].text.strip()
        # No_of_Employees = element_No_of_Employees.find('li').text.strip()
    except:
        No_of_Employees =''
...
df.to_csv('Digital Encoders Suppliers.csv', index=False)